...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2016 at 11:06 AM
...
--
CREATE TABLE IF NOT EXISTS `emp_details_view` (
...
ALTER TABLE `countries`
 ADD PRIMARY KEY (`country_id`), ADD KEY `countries_regions_region_id` (`region_id`);

--
-- Indexes for table `departments`
--
ALTER TABLE `departments`
 ADD PRIMARY KEY (`department_id`), ADD KEY `departments_locations_location_id` (`location_id`), ADD KEY `manager_id` (`manager_id`);

--
-- Indexes for table `employees`
--
ALTER TABLE `employees`
 ADD PRIMARY KEY (`employee_id`), ADD KEY `employees_jobs_job_id` (`job_id`), ADD KEY `employees_departments_department_id` (`department_id`), ADD KEY `employees_employees_employee_id` (`manager_id`);
...
ALTER TABLE `job_history`
 ADD UNIQUE KEY `employee_id` (`employee_id`,`start_date`), ADD KEY `job_history_jobs_job_id` (`job_id`), ADD KEY `job_history_departments_department_id` (`department_id`);

--
-- Indexes for table `locations`
--
ALTER TABLE `locations`
 ADD PRIMARY KEY (`location_id`), ADD KEY `locations_countries_country_id` (`country_id`);
